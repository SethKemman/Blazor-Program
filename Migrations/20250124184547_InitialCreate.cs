    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertySets", x => x.PropertySetId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_Accommodations_AccommodationId",
                        column: x => x.AccommodationId,
                        principalTable: "Accommodations",
                        principalColumn: "AccommodationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_PropertySets_PropertySetId",
                        column: x => x.PropertySetId,
                        principalTable: "PropertySets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_AccommodationId",
                table: "Properties",
                column: "AccommodationId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_PropertySetId",
                table: "Properties",
